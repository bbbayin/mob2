package com.mob.sms.skin3.network.service;
...
import com.mob.sms.skin3.bean.MsgResponse;
import com.mob.sms.skin3.bean.OneDialBean;
import com.mob.sms.skin3.bean.PhoneNumberBean;
import com.mob.sms.skin3.bean.UpdateBean;
import com.mob.sms.skin3.network.bean.AuthoLoginBean;
import com.mob.sms.skin3.network.bean.BaseBean;
import com.mob.sms.skin3.network.bean.BaseResponse;
import com.mob.sms.skin3.network.bean.CallRecordBean;
import com.mob.sms.skin3.network.bean.EnterpriseBean;
import com.mob.sms.skin3.network.bean.FeedbackDetailBean;
import com.mob.sms.skin3.network.bean.HistoryFeedBackBean;
import com.mob.sms.skin3.network.bean.LoginBean;
import com.mob.sms.skin3.network.bean.OnlineContactBean;
import com.mob.sms.skin3.network.bean.OrderBean;
import com.mob.sms.skin3.network.bean.OrderHistoryBean;
import com.mob.sms.skin3.network.bean.QuestionBean;
import com.mob.sms.skin3.network.bean.QuestionDetailBean;
import com.mob.sms.skin3.network.bean.RuleBean;
import com.mob.sms.skin3.network.bean.ShareBean;
import com.mob.sms.skin3.network.bean.SmsRecordBean;
import com.mob.sms.skin3.network.bean.UploadBean;
import com.mob.sms.skin3.network.bean.UserInfoBean;
import com.mob.sms.skin3.network.bean.VersionBean;
import com.mob.sms.skin3.network.bean.VipBean;
