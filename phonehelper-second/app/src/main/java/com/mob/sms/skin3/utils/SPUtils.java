package com.mob.sms.skin3.utils;
...
public class SPUtils {
    ...
    public static void put(String key, Object object) {
        try {
            ...
            SharedPreferences sp = MyApplication.getContext().getSharedPreferences(PREFS_NAME,
