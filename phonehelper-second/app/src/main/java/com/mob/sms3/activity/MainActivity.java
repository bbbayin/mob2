...
import com.mob.sms3.adapter.ViewPagerAdapter;
import com.mob.sms3.base.BaseActivity;
...
import com.mob.sms3.fragment.ContactsFragment;
import com.mob.sms3.fragment.HomeFragment;
import com.mob.sms3.fragment.MineFragment;
import com.mob.sms3.fragment.RecordFragment;
import com.mob.sms3.network.RetrofitHelper;
import com.mob.sms3.network.bean.BaseResponse;
import com.mob.sms3.rx.ExitEvent;
import com.mob.sms3.rx.RxBus;
import com.mob.sms3.service.UpdateService;
            ...
            public IPagerTitleView getTitleView(Context context, final int index) {
                ...
                commonPagerTitleView.setOnPagerTitleChangeListener(new CommonPagerTitleView.OnPagerTitleChangeListener() {
                    ...
                    public void onSelected(int index, int totalCount) {
                        titleImg.setImageResource(IMG_ICON_ON[index]);
                        tab.setTextColor(getResources().getColor(R.color.color_8A41FF));
                    }

                    @Override
                    public void onDeselected(int index, int totalCount) {
                        titleImg.setImageResource(IMG_ICON_OFF[index]);
                        tab.setTextColor(getResources().getColor(R.color.text_hint));
                    }
