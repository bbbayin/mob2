package com.mob.sms3.network;

import com.mob.sms3.application.MyApplication;
import com.mob.sms3.network.service.MyAPIService;
...
public class RetrofitHelper {
    ...
    public static synchronized MyAPIService getApi() {
        if (sApi == null) {
            final MyAPIService impl = createApi(MyAPIService.class, "http://dial3.shengzewang.cn/");
